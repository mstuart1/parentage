#script to estimate proportion sampled from data sheet "GPSSurveys2015.clownfish.csv" 8/3/17 --> MICHELLE SAYS THIS SHEET HAS MANY ERRORS, don't use, but script can be a reference
